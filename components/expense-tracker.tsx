...
export default function ExpenseTracker() {
  ...
  <div className="flex justify-center">                           
    <div className="flex flex-col w-2/5 items-center mt-5 mb-5 bg-gray-200">
      {/* Header section */}
      <header className="bg-gray-600 h-28 items-center w-full py-4 px-4 shadow-lg ">
      ...
      {/* Main section */}
      <main className="flex-1 w-96 h-48 overflow-y-auto py-8 px-4">
        <ul className="space-y-6">
          {expenses.map((expense) => (
            <li
              key={expense.id}
              className="bg-card p-4 bg-gray-500 rounded-lg shadow-lg flex justify-between items-center"
            >
              <div>
                <h3 className="text-2xl font-bold text-white">{expense.name}</h3>
      ...
      <div className="p-2 bottom-6 right-6">
        <Button
          size="icon"
          className="rounded-full shadow-lg mb-5 hover:bg-yellow-500 hover:text-black"
          onClick={() => {
            setShowModal(true);
            setIsEditing(false);
            resetForm();
      ...
      <div className="text-center w-full p-2 bg-gray-500 text-sm">
      <p>Designed by<b className="text-yellow-500"> MARYAM ANSARI</b></p></div>
